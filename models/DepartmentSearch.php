...
class DepartmentSearch extends Department
{
    ...
    {
        return [
            [['iddepartment', 'department_name', 'department_name2'], 'safe'],
            [['idfaculty'], 'integer'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'iddepartment', $this->iddepartment])
            ->andFilterWhere(['like', 'department_name', $this->department_name])
            ->andFilterWhere(['like', 'department_name2', $this->department_name2]);
